...
local colors = require("aylin.colors")
...
function M.setup(config)
  config = config or require("aylin.config")
  ...
  theme.base = {
    ...
    MatchParen = { fg = c.purple, style = "bold" }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    IncSearch = { bg = c.orange, fg = c.cyan }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    ...
    Function = { fg = c.green1, style = config.functionStyle }, -- function name (also: methods for classes)
  ...
  theme.plugins = {
    ...
    TSPunctDelimiter = { fg = c.purple }, -- For delimiters ie: `.`
    TSPunctBracket = { fg = c.purple }, -- For brackets and parens.
    TSPunctSpecial = { fg = c.purple }, -- For special punctutation that does not fall in the catagories before.
    ...
    TSTagAttribute      = { fg = c.green };    -- HTML tag attributes.
  ...
  -- Startify
   StartifyNumber = { fg = c.cyan },
   StartifyBracket = { fg = c.cyan },
   StartifySection = { fg = c.red, style = "bold" },
   StartifyPath = { fg = c.fg_dark },
   StartifySlash = { fg = c.fg_dark },
   StartifyFile = { fg = c.fg, bg = config.transparent and c.none or c.bg },
